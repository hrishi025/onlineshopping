...
const EditAdminProductScreen = (props) => {
  ...
  const updateProductStore = useSelector(
  ...
  const saveButton = () => {
    ...
    dispatch(
      updateProduct(prod_id, productTitle, productPrice, productQuantity)
    )
  }
...
export default EditAdminProductScreen
