...
const CategoryListScreen = (props) => {
  ...
  useEffect(async () => {
    if (deleteCategoryStore.response && deleteCategoryStore.response.status == "success") {
      dispatch({ type: CATEGORY_DELETE_RESET })
      await dispatch(getCategory());
      await setDeleteStatus(false)
    }
  }, [deleteCategoryStore.response, deleteCategoryStore.error, deleteCategoryStore.loading])
    ...
    <div className="container">
      ...
      <div className="border border-light p-3 mb-4">
        <div className="text-center">
          <button onClick={onAddCategory} className="btn btn-secondary float-end">
